    ...
    return (
        <main className="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="w-full max-w-2xl mt-12 text-left">
                <Link href="/blog/welcome-to-the-dashboard" className="group block bg-surface-raised border border-surface-border rounded-2xl p-6 hover:border-accent/20 transition-all duration-300">
                    <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="mt-2 text-slate-600 group-hover:text-accent group-hover:translate-x-1 transition-all">
                            <ChevronRight />
                        </div>
                    </div>
                </Link>
