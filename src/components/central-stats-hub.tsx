...
export function CentralStatsHub({ stats, softwareProjectsCount = 0 }: CentralStatsHubProps) {
    return (
        <motion.div
            ...
            className="relative z-10 flex flex-col items-center justify-center p-8 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.05] shadow-[0_8px_32px_rgba(0,0,0,0.3)] max-w-sm mx-auto min-w-[280px]"
        >
            ...
            <div className="w-full h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent my-4 z-10" />

            <div className="flex flex-col w-full z-10 gap-4 mt-2">
                <div className="flex justify-between items-center w-full">
                    <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Subscribers</span>
                ...
                <div className="flex justify-between items-center w-full">
                    <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Views</span>
                    <span className="text-xl font-bold text-white">
