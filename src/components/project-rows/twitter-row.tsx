    ...
    return (
        <div className="group bg-surface-raised border border-surface-border rounded-[20px] hover:border-accent/20 transition-all duration-300 font-mono p-6 flex flex-col gap-6 relative overflow-hidden">
            ...
            <div className="flex items-center gap-5">
                <div className="p-3 bg-[#1DA1F2]/10 rounded-full group-hover:scale-105 transition-transform flex items-center justify-center min-w-12 min-h-12">
            ...
            {/* Bottom: Metrics Grid */}
            {(followerMetric || impressionMetric) && (
            <div className="grid grid-cols-2 gap-y-4 gap-x-4">
                ...
                {impressionMetric && (
                    <div className="flex flex-col text-left">
                        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-1">Impressions</span>
                        <span className="font-bold text-white text-base">
