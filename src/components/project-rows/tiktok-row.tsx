    ...
    return (
        <div className="group bg-surface-raised border border-surface-border rounded-[20px] hover:border-accent/20 transition-all duration-300 font-mono p-6 flex flex-col gap-6 relative overflow-hidden">
            ...
            <div className="flex items-center gap-5">
                <div className="p-3 bg-neutral-900 rounded-full group-hover:scale-105 transition-transform flex items-center justify-center min-w-12 min-h-12 border border-[#69C9D0]/30 shadow-[4px_4px_0_rgba(238,29,82,0.15),-4px_-4px_0_rgba(105,201,208,0.15)]">
            ...
            {/* Bottom: Metrics Grid */}
            {(followerMetric || likesMetric || viewMetric) && (
            <div className="grid grid-cols-2 gap-y-4 gap-x-4">
                {followerMetric && (
                    <div className="flex flex-col text-left">
                        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-1">Followers</span>
                ...
                {likesMetric && (
                    <div className="flex flex-col text-left">
                        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-1">Likes</span>
                        <span className="font-bold text-white text-base">
                ...
                {viewMetric && (
                    <div className="flex flex-col text-left">
                        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-1">Views</span>
                        <span className="font-bold text-white text-base">
